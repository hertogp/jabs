...
# TODO
# o create 1 data.py autogenerated file with IP4PROTOCOLS and IP4SERVICES
# o split ilf.py into helpers.py, filter.py
# o import relevant objs in ilf's __init__.py
# o ilf/
#   __init__.py     <-- all = Ip4Protocol, Ip4Service, Ip4Filter
#   update_data.py  <-- updates/rewrites data.py
#   data.py         <-- IP4PROTOCOLS, IP4SERVICES
#   service.py      <-- Ip4Service
#   protocol.py     <-- Ip4Protocol
#   helpers.py      <-- Ival
#   filter.py       <-- Ip4Filter
#
